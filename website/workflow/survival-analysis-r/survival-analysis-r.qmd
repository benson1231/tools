...
以下範例參考 [UVA HSL Research & Data Courses](https://bioconnector.github.io/workshops/r-survival.html) 之 workshop 內容
:::
...
本頁內容為教學筆記之**重新整理與改寫版本**，其課程架構與部分範例概念改作自  
University of Virginia Health Sciences Library（UVA HSL）所提供之  
[BIMS 8382：Research & Data Courses / Workshops](https://bioconnector.github.io/workshops/r-survival.html) 教學材料。

- **原作授權**：[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)

- **本改作授權**：[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)（依相同授權條款釋出）
