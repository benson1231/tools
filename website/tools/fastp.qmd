...
::: {.callout-note}
fastp 是目前業界（以及 nf-core、GATK Best Practices）中最常見的定序前處理工具之一。
...
[Shifu Chen. fastp 1.0: An ultra-fast all-round tool for FASTQ data quality control and preprocessing. iMeta 4.5 (2025): e70078](https://pmc.ncbi.nlm.nih.gov/articles/PMC12527978/)
:::
...
此外，fastp 會輸出 [HTML(官方範例)](http://opengene.org/fastp/fastp.html) 與 [JSON(官方範例)](http://opengene.org/fastp/fastp.json) 格式的 QC 報告，內容包含：
...
```bash
fastp \
-i data/fastq/a.chr21_R1.fastq.gz \
-I data/fastq/a.chr21_R2.fastq.gz \
